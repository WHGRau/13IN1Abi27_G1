...
public class DatabaseConnector {
   ...
   * Datenbank
   * wird aufgebaut. Mit den Parametern pIP und pPort werden die IP-Adresse und
   * die
   * Port-Nummer uebergeben, unter denen die Datenbank mit Namen pDatabase zu
   * erreichen ist.
   * Mit den Parametern pUsername und pPassword werden Benutzername und Passwort
   * fuer die
   ...
   * an
   * die Datenbank geschickten SQL-Befehls als Ob-jekt vom Typ QueryResult
   * zurueck.
